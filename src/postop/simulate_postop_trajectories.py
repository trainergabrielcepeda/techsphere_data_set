...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    perfiles_pacientes_table = config.table_fqn("silver", "perfiles_pacientes", cfg, catalog_override=args.catalog)
    output_table = config.table_fqn("silver", "trayectorias_postop", cfg, catalog_override=args.catalog)
